...
import { User, Link as LinkIcon, Save, Plus, Trash2, Mail, Phone, ChevronRight, FileText, Menu, Settings } from 'lucide-react';
        ...
        <div className="flex min-h-screen bg-[#050505]">
            ...
            <div className="flex-1 md:ml-64 min-h-screen relative overflow-hidden">
                ...
                <div className="md:hidden flex items-center gap-3 px-4 py-3 bg-[#161822] border-b border-[#252836] sticky top-0 z-30">
                    ...
                    <h1 className="text-white font-bold flex-1 text-lg">Settings</h1>
                </div>
                                            ...
                                            <div>
                                                ...
                                                <div className="space-y-3">
                                                    {socialInputs.map((item) => (
                                                        <div key={item.id} className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                                                            <select
                                                                value={item.platform}
                                                                onChange={(e) => updateSocialInput(item.id, 'platform', e.target.value)}
                                                                className="w-full sm:w-1/3 md:w-1/4 px-4 py-3 bg-black/30 border border-white/10 rounded-xl text-white focus:outline-none focus:border-[#915EFF] transition-colors appearance-none"
                                                            >
                                                            ...
                                                            <button
                                                                ...
                                                                className="p-3 bg-red-500/10 text-red-500 hover:bg-red-500 hover:text-white rounded-xl transition-colors border border-red-500/20 self-end sm:self-auto"
                                                            >
